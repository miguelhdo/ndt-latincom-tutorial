...
from six.moves import urllib  # Consolidates urllib imports under six.moves
...
class NDTDataset:
    ...
    def extract_zip_2(self, path, folder, log=True):
        # From https://github.com/rusty1s/pytorch_geometric/blob/master/torch_geometric/data/extract.py
    ...
    def extract_zip(self, path, folder, log=True):
        ...
        try:
            ...
            print("Extraction failed: File is not a valid zip file.")
